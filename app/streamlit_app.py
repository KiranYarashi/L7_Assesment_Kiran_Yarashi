...
st.title("Chocolate House Management")
...
option = st.radio("Select an option", ["View Flavors", "Add Flavor", "Delete Flavor", "Manage Ingredients", "Customer Suggestions"])

# Handle the selected option
if option == "View Flavors":
    st.write("Viewing Flavors")
    # Add code to view flavors
elif option == "Add Flavor":
    st.write("Adding Flavor")
    # Add code to add flavor
elif option == "Delete Flavor":
    st.write("Deleting Flavor")
    # Add code to delete flavor
elif option == "Manage Ingredients":
    st.write("Managing Ingredients")
    # Add code to manage ingredients
